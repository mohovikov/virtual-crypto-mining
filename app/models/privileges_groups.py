...
class PrivilegesGroups(db.Model):
    ...
    name: Mapped[Optional[str]] = mapped_column(String(30), nullable=False, unique=True, index=True)
    privileges: Mapped[Optional[int]] = mapped_column(Integer, nullable=False)
